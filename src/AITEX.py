...
def CreateAitexDataset(resize, log_file):
    try:
        myPrint("Preparing the AITEX dataset...", log_file)
        ...
        myPrint(e, log_file)
        myPrint("Error in CreateAitexDataset function!", log_file)
...
def download(log_file):
    myPrint("Download AITEX dataset...", log_file)
    ...
    try:
        ...
        myPrint(e, log_file)
        myPrint("Can't download AITEX dataset. Retry later.", log_file)
        sys.exit(-1) 
